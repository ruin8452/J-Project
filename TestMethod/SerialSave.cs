...
{
    /**
     *  @brief SerialSave 테스트 세팅 데이터
     *  @details SerialSave 테스트 데이터 관리를 담당하는 클래스
     *
     *  @author SSW
     *  @date 2020.02.25
     *  @version 1.0.0
     */
    public class SerialSave : Test
    {
        ...
        private static SerialSave SingleTonObj = null;
        ...
        public static SerialSave GetObj()
        {
            if (SingleTonObj == null) SingleTonObj = new SerialSave();
            return SingleTonObj;
        }
